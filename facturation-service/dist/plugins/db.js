/**
 * facturation-service — Plugin PostgreSQL
 */
import fp from 'fastify-plugin';
import fastifyPostgres from '@fastify/postgres';
export default fp(async function dbPlugin(fastify) {
    const connectionString = process.env.FACTURATION_DATABASE_URL ||
    ...
    fastify.log.info('✅ PostgreSQL connecté (facturation-service)');
}, {
    name: 'db-plugin',
});
